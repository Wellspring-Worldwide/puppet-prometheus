...
class prometheus::server (
  ...
  Prometheus::Absolutepath $shared_dir                              = $prometheus::shared_dir,
  String $version                                               = $prometheus::version,
  String $install_method                                        = $prometheus::install_method,
  Variant[Prometheus::HTTPUrl, Prometheus::HTTPSUrl] $download_url_base = $prometheus::download_url_base,
  ...
  Prometheus::Absolutepath $localstorage                            = $prometheus::localstorage,
  ...
  Prometheus::Absolutepath $env_file_path                           = $prometheus::env_file_path,
